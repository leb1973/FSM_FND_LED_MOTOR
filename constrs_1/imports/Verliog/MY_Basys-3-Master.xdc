...
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { i_fansw[0]  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { i_fansw[1]  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { i_fansw[2]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
...
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { i_button[2] }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports { i_button[3] }]; #IO_L17P_T2_A14_D30_14 ,Sch=BTNR
set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { i_button[4] }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND


##Pmod Header JA

set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports {o_motor}]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
...
#set_property -dict { PACKAGE_PIN A14  IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L6P_T0_16       ,Sch=JB1
